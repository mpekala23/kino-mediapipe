...
http_archive(
    ...
    patches=["@//third_party:com_google_absl_windows_patch.diff"],
    patch_args=[
        "-p1",
    ],
...
http_archive(
    ...
    urls=[
        "https://github.com/google/multichannel-audio-tools/archive/1f6b1319f13282eda6ff1317be13de67f4723860.zip"
    ],
...
http_archive(
    ...
    patches=["@//third_party:ceres_solver_compatibility_fixes.diff"],
    patch_args=[
        "-p1",
    ],
...
new_local_repository(
    name="linux_ffmpeg", build_file="@//third_party:ffmpeg_linux.BUILD", path="/usr"
)
...
http_archive(
    ...
    patches=["@//third_party:stb_image_impl.diff"],
    patch_args=[
        "-p1",
    ],
)
